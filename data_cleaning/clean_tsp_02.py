...
def clean_up(path_to_folder, date_for_imputing):
	...
	# delete files from list remove_files

	# return sttistic: looked through xx files, removed advert text from x files / articles, mean number of removals: all removals / x

	#mean(remove_files) # mean over all files looked at.
